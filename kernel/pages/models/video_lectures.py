...
class VideoLectures(models.Model):
    ...
    drug = models.OneToOneField("pages.Drug", on_delete=models.CASCADE, blank=True, null=True)
    video_recomendations = models.ForeignKey('VideoLectures', on_delete=models.CASCADE, limit_choices_to={'video_article': models.F('video_recomendations__video_article')}, null=True, blank=True)
